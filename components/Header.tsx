    ...
    <header className="text-center mb-8 w-full max-w-4xl mx-auto px-4">
      ...
      >
        ...
        >
          ...
          <rect x="10" y="10" width="280" height="130" rx="15" fill="#013598" />
          <rect x="15" y="15" width="270" height="120" rx="12" fill="#002A88" />

          {/* Screen bezel - centered and taller */}
          <rect x="60" y="20" width="160" height="95" rx="4" fill="#1A1B1E" />

          {/* Screen frame */}
          <rect x="65" y="25" width="150" height="85" fill="#232323" />

          {/* Screen Container */}
          <foreignObject x="70" y="30" width="140" height="75">
          ...
          <g transform="translate(265, 75)">
            <circle cx="0" cy="0" r="12" fill="#A93671" />
